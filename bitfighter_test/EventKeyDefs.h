...
SDL_Keycode keyDown = InputCodeManager::inputCodeToSDLKey(                                                \
            clientSettings->getInputCodeManager()->getBinding(BINDING_DOWN, InputModeKeyboard));          \
                                                                                                          \
...
EventDownReleased.key.keysym.sym = keyDown;                                                               \
                                                                                                          \
InputCode KEY_MOD1 = clientSettings->getInputCodeManager()->getBinding(BINDING_MOD1, InputModeKeyboard);  \
