...
SOURCES     := $(SOURCES) 
DATA		:=	data
INCLUDES	:=	/opt/devkitpro/portlibs/3ds/include/SDL zap clipper fontstash poly2tri poly2tri/sweep poly2tri/common tnl tnlping tomcrypt/src/headers lua/luajit/src
GRAPHICS	:=	gfx
GFXBUILD	:=	$(BUILD)
#ROMFS		:=	romfs
#GFXBUILD	:=	$(ROMFS)/gfx
