...
BUILD              := build
SOURCES            := zap clipper fontstash poly2tri/sweep poly2tri/common tnl
...
DATA               := data
INCLUDES           := lib/include/luajit-2.1 zap clipper fontstash poly2tri poly2tri/sweep poly2tri/common tnl tomcrypt/src/headers
GRAPHICS           := gfx
GFXBUILD           := $(BUILD)
#ROMFS             := romfs
#GFXBUILD          := $(ROMFS)/gfx
