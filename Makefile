...
BUILD              := build
SOURCES            := zap clipper fontstash poly2tri/sweep poly2tri/common tnl recast
...
CFLAGS	+=	$(INCLUDE) -Iinclude -D__3DS__ -DBF_PLATFORM_3DS -DBF_NO_AUDIO -Dlinux -DTNL_NO_THREADS -DLTC_SOURCE -DLTC_NO_ROLC -DENDIAN_NEUTRAL -DTNL_ENABLE_ASSERTS -DBF_3DS_EMULATOR
