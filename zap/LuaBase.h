...
#  define LUA_ARG_TYPE_TABLE \
   ...
   LUA_ARG_TYPE_ITEM( SIMPLE_LINE, "Pair of Lua points (individually or in a table)"      ) \
   LUA_ARG_TYPE_ITEM( LINE,        "Two or more Lua points (individually or in a table)"  ) \
   LUA_ARG_TYPE_ITEM( POLY,        "Three or more Lua points (individually or in a table)") \
