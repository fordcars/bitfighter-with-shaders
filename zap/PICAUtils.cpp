...
// From: https://github.com/citra-emu/citra/blob/b3cab3c4507dc1b28e2f15b2e0c9f473f6e1959f/src/video_core/utils.h
...
U32 screenCoordsToTexOffset(U32 x, U32 y, U32 texHeight)
{
   U32 coarse_y = (texHeight - y) & ~7;
   return GetMortonOffset(x, texHeight - y, 1) + coarse_y * texHeight;
}
